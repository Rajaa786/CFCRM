...
class ProductsAndPolicy(models.Model):
    ...
    sub_product = models.ForeignKey(
        SubProduct, on_delete=models.CASCADE, null=True, blank=True)
    effective_date = models.DateField(blank=True, null=True)
    ineffective_date = models.DateField(null=True, blank=True)
    bank_name = models.ForeignKey(
        BankName, on_delete=models.CASCADE, null=True, blank=True)
...
class CustomerDesignation(models.Model):
    ...
    product = models.ForeignKey(
        ProductsAndPolicy, on_delete=models.CASCADE, null=True)
    bank_id = models.ForeignKey(Bank, on_delete=models.CASCADE, null=True)
...
class HlObligation(models.Model):
    ...
    gold_loan_percent = models.IntegerField()
    basic_details_id = models.ForeignKey(
        HlBasicDetails, on_delete=models.CASCADE, null=True, blank=True)
    effective_date = models.DateTimeField(blank=True, null=True)
    ineffective_date = models.DateTimeField(blank=True, null=True)
    pid = models.ForeignKey(ProductsAndPolicy, on_delete=models.CASCADE)
...
class HlProperty(models.Model):
    ...
    percent_of_completion = models.FloatField(
...
class HlIncome(models.Model):
    ...
    bonus_avg_monthly_percentage = models.FloatField(
        validators=[MinValueValidator(0.0), MaxValueValidator(100.0)])
    ...
    bonus_avg_quarterly_percentage = models.FloatField(
        validators=[MinValueValidator(0.0), MaxValueValidator(100.0)])
    ...
    bonus_avg_half_yearly_percentage = models.FloatField(
        validators=[MinValueValidator(0.0), MaxValueValidator(100.0)])
    ...
    bonus_avg_yearly_percentage = models.FloatField(
        validators=[MinValueValidator(0.0), MaxValueValidator(100.0)])
    income_foir_yearly = models.BooleanField()
    rent_income = models.BooleanField()
    rent_agreement_type = models.ForeignKey(
...
class HlIncomeFoir(models.Model):
    ...
    income_foir_percentage = models.FloatField(
        validators=[MinValueValidator(0.0), MaxValueValidator(100.0)])
    basic_details_id = models.ForeignKey(
        HlBasicDetails, on_delete=models.CASCADE, blank=True, null=True)
    effective_date = models.DateTimeField(blank=True, null=True)
    ineffective_date = models.DateTimeField(blank=True, null=True)
    pid = models.ForeignKey(ProductsAndPolicy, on_delete=models.CASCADE)
...
class Cibil(models.Model):
    ...
    cibil_loan_type_id = models.ForeignKey(
        CibilLoanType, on_delete=models.CASCADE, null=True)
